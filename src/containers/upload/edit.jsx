                    ...
                    <div className="p-3">
                        <label htmlFor="title" className="block w-full mb-3">
                            ...
                            <input
                                name="title"
                                type="text"
                                className="py-2 focus:ring-0 focus:outline-none border-b w-full bg-black text-slate-200"
                    ...
                    <div className="p-3">
                        <label htmlFor="caption" className="block w-full mb-3">
                            ...
                            <textarea       
                                name="caption"
                                type="text"
                                className="py-2 focus:ring-0 focus:outline-none border-b w-full resize-none bg-black text-slate-200"
